    ...
    public class WhenLookingForMediaForAShow
    {
        ...
        public void FullPathShouldBeAssignedCorrectly()
        {
            var fileSystem = new MockFileSystem(new Dictionary<string, MockFileData>
            {
                ...
                {
                    MockUnixSupport.Path(@"c:\video\ShowName Us\S01E01\ShowName.Us.S01E01.720p.HDTV-GROUP.mkv"),
                    new MockFileData("")
                }
            });
            ...
            foundMedia.ElementAt(0)
                .Path.Should()
                .Be(MockUnixSupport.Path(@"c:\video\ShowName\S01E01\ShowName.S01E01.720p.HDTV-GROUP.mkv"));
        ...
        public void IfShowExistButAlsoAnNfoExistOnlyTheShowShouldBeReturned()
        {
            var fileSystem = new MockFileSystem(new Dictionary<string, MockFileData>
            {
                ...
                {
                    MockUnixSupport.Path(@"c:\video\ShowName\S01E01\ShowName.S01E01.720p.HDTV-GROUP.nfo"),
                    new MockFileData("")
                }
            });
            var mediaFinder = new MediaFinder(MockUnixSupport.Path(@"c:\video"), fileSystem);
        ...
        public void OnlyMediaForTheCorrectShowShouldBeFound()
        {
            var fileSystem = new MockFileSystem(new Dictionary<string, MockFileData>
            {
                ...
                {
                    MockUnixSupport.Path(@"c:\video\OtherShow\S01E01\OtherShow.S01E01.720p.HDTV-GROUP.mkv"),
                    new MockFileData("")
                }
            });
            var mediaFinder = new MediaFinder(MockUnixSupport.Path(@"c:\video"), fileSystem);
        ...
        public void OnlyMediaWithAProperMediaExtensionShouldBeFound()
        {
            var fileSystem = new MockFileSystem(new Dictionary<string, MockFileData>
            {
                ...
                {
                    MockUnixSupport.Path(@"c:\video\ShowName\S01E01\ShowName.S01E01.720p.HDTV-GROUP.avi"),
                    new MockFileData("")
                },
                {
                    MockUnixSupport.Path(@"c:\video\ShowName\S01E01\ShowName.S01E01.720p.HDTV-GROUP.nfo"),
